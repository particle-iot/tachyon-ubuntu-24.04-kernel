...
/* SC7280 running the Gen2 firmware; built at probe, see iris_platform_gen1.c. */
struct iris_platform_data *iris_sc7280_gen2_platform_data(struct device *dev);
extern bool iris_sc7280_gen2;
...
struct iris_platform_data {
	...
	bool no_aon;
	/*
	 * Ask the firmware to derive the rate-control budget from the
	 * configured frame rate rather than from buffer timestamps. Only set
	 * it where the firmware is known to accept the property.
	 */
	bool rc_from_frame_rate;
